...
Model.train((data, theta, score_mask, fisher_mask), lr=5e-4, epochs=250)
model_checkpoint(Model=Model, checkpoint=0)
Model.train((data, theta, score_mask, fisher_mask), lr=1e-4, epochs=250)
model_checkpoint(Model=Model, checkpoint=1)
Model.train((data, theta, score_mask, fisher_mask), lr=5e-5, epochs=250)
model_checkpoint(Model=Model, checkpoint=2)
Model.train((data, theta, score_mask, fisher_mask), lr=1e-6, epochs=125)
model_checkpoint(Model=Model, checkpoint=3)
Model.train((data, theta, score_mask, fisher_mask), lr=5e-6, epochs=125)
model_checkpoint(Model=Model, checkpoint=4)

# increase batch size to 8x512
Model.train((data, theta, score_mask, fisher_mask), lr=5e-4, batch_size=8*512, epochs=250)
model_checkpoint(Model=Model, checkpoint=5)
Model.train((data, theta, score_mask, fisher_mask), lr=1e-4, batch_size=8*512, epochs=250)
model_checkpoint(Model=Model, checkpoint=6)
Model.train((data, theta, score_mask, fisher_mask), lr=5e-5, batch_size=8*512, epochs=250)
model_checkpoint(Model=Model, checkpoint=7)
Model.train((data, theta, score_mask, fisher_mask), lr=1e-6, batch_size=8*512, epochs=125)
model_checkpoint(Model=Model, checkpoint=8)
Model.train((data, theta, score_mask, fisher_mask), lr=5e-6, batch_size=8*512, epochs=125)
model_checkpoint(Model=Model, checkpoint=9)
